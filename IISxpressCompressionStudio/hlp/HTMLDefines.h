...
#define HID_TOOLS_LOCATEIP                      0x18003
#define HID_POPUP_CLEAR                         0x18005
#define HID_HISTORY_CLEAR                       0x18006
#define HID_HISTORY_AUTOSCROLL                  0x18007
#define HID_HISTORYCONTEXT_CLEAR                0x18008
#define HID_HISTORYCONTEXT_AUTOSCROLL           0x1800A
#define HID_HISTORYCONTEXT_WRITETOCSV           0x1800B
#define HID_WEBDIRCONTEXT_WRITETOCSV            0x1800C
#define HID_TOOLS_IISADMINISTRATION             0x1800D
#define HID_WEBDIRCONTEXT_EXPLOREFOLDER         0x1800E
#define HID_HISTORYCONTEXT_EXPLORECONTAININGFOLDER	0x1800F
#define HID_HISTORYCONTEXT_EXCLUDE              0x18010
#define HID_EXCLUDE_EXCLUDETHISEXTENSION        0x18011
#define HID_EXCLUDE_EXCLUDETHISCONTENTTYPE      0x18012
#define HID_EXCLUDE_EXCLUDEMATCHINGCONTENTTYPES 0x18013
#define HID_EXCLUDE_EXCLUDETHISDIRECTORY        0x18014
#define HID_EXCLUDE_EXCLUDETHISDIRECTORYTREE    0x18015
#define HID_EXCLUDE_EXCLUDETHISWEBSITE          0x18016
#define HID_EXCLUDE_EXCLUDETHISCLIENT           0x18017
#define HID_EXCLUDE_EXCLUDETHISCLIENTSUBNET     0x18018
#define HID_WEBDIRCONTEXT_ANALYZE               0x18019
#define HID_WEBDIRCONTEXT_ANALYSIS              0x1801A
#define HID_ANALYSIS_ANALYZE                    0x1801B
#define HID_ANALYSIS_CLEAR                      0x1801C
#define HID_WEBDIRCONTEXT_CLEAR                 0x1801D
#define HID_WEBDIRCONTEXT_OPENWITHDEFAULTAPPLICATION	0x18021
#define HID_WEBDIRCONTEXT_OPENWITHNOTEPAD       0x18022
#define HID_WEBDIRECTORYHEADERCONTEXT_FILENAME  0x18023
#define HID_WEBDIRECTORYHEADERCONTEXT_FILESIZE  0x18024
#define HID_WEBDIRECTORYHEADERCONTEXT_ORIGINALSIZE	0x18025
#define HID_WEBDIRECTORYHEADERCONTEXT_COMPRESSEDSIZE	0x18026
#define HID_WEBDIRECTORYHEADERCONTEXT_RATIO     0x18027
#define HID_WEBDIRECTORYHEADERCONTEXT_RESPONSES 0x18028
#define HID_WEBDIRECTORYHEADERCONTEXT_LASTDOWNLOAD	0x18029
#define HID_HISTORYHEADERCONTEXT_URI            0x18037
#define HID_HISTORYHEADERCONTEXT_TIME           0x18038
#define HID_HISTORYHEADERCONTEXT_HOSTNAME       0x18039
#define HID_HISTORYHEADERCONTEXT_PORT           0x1803A
#define HID_HISTORYHEADERCONTEXT_CACHED         0x1803B
#define HID_HISTORYHEADERCONTEXT_ORIGINALSIZE   0x1803C
#define HID_HISTORYHEADERCONTEXT_COMPRESSEDSIZE 0x1803D
#define HID_HISTORYHEADERCONTEXT_RATIO          0x1803E
#define HID_HISTORYHEADERCONTEXT_CONTENTTYPE    0x1803F
#define HID_HISTORYHEADERCONTEXT_CLIENTIP       0x18040
#define HID_HISTORYHEADERCONTEXT_LOCATION       0x18041
#define HID_HISTORYHEADERCONTEXT_BROWSER        0x18042
#define HID_HISTORYHEADERCONTEXT_USERAGENT      0x18043
#define HID_WEBDIRHEADERCONTEXT_QUERYSTRING     0x18044
#define HID_HISTORYHEADERCONTEXT_QUERYSTRING    0x18045
#define HID_HISTORYHEADERCONTEXT_COMPRESSIONTIME	0x18046
#define HID_WEBDIRECTORYHEADERCONTEXT_CONTENTTYPE	0x18047
#define HID_WEBDIRCONTEXT_COMPRESSAUTOMATIC     0x18050
#define HID_WEBDIRCONTEXT_COMPRESSALWAYS        0x18051
#define HID_WEBDIRCONTEXT_COMPRESSNEVER         0x18052
#define HID_WEBDIRCONTEXT_EXCLUDETHISEXTENSION  0x18053
#define HID_WEBDIRCONTEXT_EXCLUDETHISCONTENTTYPE	0x18054
#define HID_WEBDIRCONTEXT_EXCLUDEMATCHINGCONTENTTYPES	0x18055
#define HID_WEBDIRECTORYHEADERCONTEXT_COMPRESS  0x18056
#define HID_VIEW_REFRESH                        0x18057
#define HID_WEBDIRCONTEXT_BROWSEWITHINTERNETEXPLORER	0x1805F
#define HID_WEBDIRCONTEXT_BROWSEWITHFIREFOX     0x18060
#define HID_WEBDIRCONTEXT_BROWSEWITHOPERA       0x18061
#define HID_WEBDIRCONTEXT_BROWSEWITHSAFARI      0x18062
#define HID_WEBTREECONTEXT_BROWSEWITHINTERNETEXPLORER	0x18066
#define HID_WEBTREECONTEXT_BROWSEWITHFIREFOX    0x18067
#define HID_WEBTREECONTEXT_BROWSEWITHOPERA      0x18068
#define HID_WEBTREECONTEXT_BROWSEWITHSAFARI     0x18069
#define HID_WEBTREECONTEXT_EXPLOREFOLDER        0x1806A
#define HID_WEBDIRCONTEXT_ZLIB                  0x1806C
#define HID_EDIT_SELECTALL                      0x1806E
#define HID_VIEW_TOOLBARS                       0x1806F
#define HID_TOOLBARS_LOCATE                     0x18070
#define HID_TOOLBARS_BROWSERS                   0x18071
#define HID_TOOLBARS_EXCLUSIONRULES             0x18072
#define HID_ANALYSIS_CSS                        0x18073
#define HID_WEBDIRCONTEXT_CSS                   0x18074
 
// Prompts (IDP_*) 
 
// Resources (IDR_*) 
#define HIDR_IISXPRESSCOMPRESSIONSTUDIO         0x20067
#define HIDR_MAINFRAME                          0x20080
#define HIDR_MENU_HISTORYCONTEXT                0x20096
#define HIDR_MENU_WEBDIRCONTEXT                 0x20097
#define HIDR_MENU_HISTORYHEADERCONTEXT          0x20099
#define HIDR_MENU_WEBDIRHEADERCONTEXT           0x2009A
#define HIDR_MENUWEBTREECONTEXT                 0x200A4
 
// Dialogs (IDD_*) 
#define HIDD_ABOUTBOX                           0x20064
#define HIDD_DIALOG_WEBSITESELECT               0x20082
#define HIDD_DIALOG_LOCATEIP                    0x20092
#define HIDD_TOOLBAR_LOCATEIP                   0x200A5
#define HIDD_DIALOG_COMPRESSIONOPTIMIZER        0x200A6
#define HIDD_TOOLBAR_BROWSERS                   0x200B1
#define HIDD_TOOLBAR_EXCLUSIONRULES             0x200BE
