...
class IISXPRESSLIB_DLL IISxpressRegSettings
{

public:

	IISxpressRegSettings(void);

	virtual ~IISxpressRegSettings(void);	

	void Init(LPCSTR pszRegPath, bool bLoad, bool bRegisterChangeHandler = false);
	void Init(LPCWSTR pszRegPath, bool bLoad, bool bRegisterChangeHandler = false);
...
protected:
	...
	Ripcord::Types::AutoHandle::AutoEventHandle m_NotificationTermEvent;
