...
#ifndef __MYATLPERF_INL__
#define __MYATLPERF_INL__

#pragma once
 
#ifndef __MYATLPERF_H__
	#error myatlperf.inl requires myatlperf.h to be included first
#endif
...
inline HRESULT CPerfMon::Initialize() throw()
{
	...
	_ATLTRY
	{
		...
		// CM: we want to allow other members of IIS_WPG access to the perf counters
		CSid sidIISWPG;
		if (sidIISWPG.LoadAccount(_T("IIS_WPG")))
		{
			dacl.AddAllowedAce(sidIISWPG, GENERIC_ALL);
		}
		...
		// CM: we don't care who owns the mutex...
